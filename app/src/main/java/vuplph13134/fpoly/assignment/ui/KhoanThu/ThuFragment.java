...
import vuplph13134.fpoly.assignment.adapter.ThuFragMentAdapter;
...
public class ThuFragment extends Fragment {
    ...
    private ThuFragMentAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mtl = view.findViewById(R.id.tab_loai_thu);
        mvp = view.findViewById(R.id.viewPager_lt);
        adapter = new ThuFragMentAdapter(getActivity().getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
